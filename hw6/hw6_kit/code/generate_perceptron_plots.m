...
close all
addpath ./libsvm
answers{1} = 'a. constant converges more quickly \n b. constant has lower training error \n c. Passive aggressive has lowest test error d. Still worse than SVM, this is expected because perceptron is only gauranteed to approach minimum, while batch learning finds the minimum';
